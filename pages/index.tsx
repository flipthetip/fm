      ...
      <div className='h-100%'>
        ...
        <Navbar />
                ...
                {allowed ? 
                      <ul className="text-center leading-10 ">
                        ...
                        <li className="m-5" onClick={() => { setNbToken('one'); reset() }}>
                          ...
                          <h4 className="text-lg font-bold text-white md:pl-12 pr-12">
                          ♦ MULTIPLE WALLET RECEIVERS
                              </h4>
                              <p className='text-amber-300 md:pl-12 pr-12'>Send SOL/SPL token to multiple wallets in 1 go.</p>
                          </div>
                        </li>
                        ...
                        {/* <li className="m-5" onClick={() => { setNbToken('multi'); reset() }}>
                          <div className="p-4 hover:border">
                            ...
                            <div>Send multiple SPL tokens to one receiver.</div>
                          </div>
                        </li>
                        ...
                        <li className="m-5">
                          ...
                          ♦ USE CSV (SOON)
                              ...
                              <p className='text-amber-300 md:pl-12 pr-12'>Use a CSV file to Distribute/Send SOL/Tokens to more than 1 wallet in 1 go.</p>
                            {/* <a className="text-4xl font-bold mb-5">
                              Use CSV (SOON)
                            </a>
                        ...
                        <ul className="text-left leading-10">
                          <li className="m-5" onClick={() => { setCurrencyType('SOL'); reset() }}>
                            ...
                            ♦ MASS SEND SOL
                              ...
                              <p className='text-amber-300 md:pl-12 pr-12'>Send SOL to different wallets in 1 go.</p>
                              {/* <a className="text-4xl font-bold mb-5">
                          ...
                          <li className="m-5" onClick={() => { setCurrencyType('SPL'); reset() }}>
                            ...
                            ♦ MASS SEND SPL Tokens
                              ...
                              <p className='text-amber-300 md:pl-12 pr-12'>Send SOL to different wallets in 1 go. (DUST, CRIM, FOXY etc.)</p>
                              {/* <a className="text-4xl font-bold mb-5">
                              ♦ MASS SEND SPL Tokens
                              </a>
                        ...
                        <div className=" min-h-96 mb-20 pt-10">
                          ...
                          <form className="mt-[3%] mb-[2%]">
                            ...
                            <div className="flex justify-center mb-[2%]">
                              <div className="my-auto mx-2">SAME AMOUNT?</div>
                              ...
                              {isChecked &&
                                <div className="flex items-center text-white">
                                  <input className="w-[150px] bg-orange-600 mx-4 text-white pl-1 text-white border-0 text-2xl font-bold text-center"
                                    ...
                                    style={{
                                      // borderRadius:
                                      //   "var(--rounded-btn,0rem) var(--rounded-btn,0rem)",
                                    }}
                                  /></div>
                              }
                            ...
                            <div>
                              ...
                              <input className="mb-[1%] md:w-[480px] bg-gray-900 text-white text-center h-10 mx-4 pl-1 border-0 border-black"
                                type="text"
                                required
          ...
          <div className='lg:mx-96 mb-4 mt-2 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-2'>
            ...
            <div className={styles.pic2}>
              <div className='mr-32 w-10 h-2 lg:w-12 lg:h-12 lg:mr-80 mb-2'>
